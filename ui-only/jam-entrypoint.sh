...
JAM_JMWALLETD_WEBSOCKET_PROXY="${JAM_JMWALLETD_HOST}:${JAM_JMWALLETD_WEBSOCKET_PORT:-$JAM_JMWALLETD_API_PORT}"
echo "Will proxy requests for /jmws to ${JAM_JMWALLETD_WEBSOCKET_PROXY}/api/v1/ws"

export JAM_JMOBWATCH_PROXY
JAM_JMOBWATCH_PROXY="${JAM_JMOBWATCH_HOST:-$JAM_JMWALLETD_HOST}:${JAM_JMOBWATCH_PORT}"
