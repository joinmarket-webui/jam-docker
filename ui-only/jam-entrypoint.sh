...
export JAM_JMWALLETD_WEBSOCKET_PATH=${JAM_JMWALLETD_WEBSOCKET_PATH:-/api/v1/ws}
...
echo "Will proxy requests for /jmws to ${JAM_JMWALLETD_WEBSOCKET_PROXY}${JAM_JMWALLETD_WEBSOCKET_PATH}"
